...
- [目录](#目录)
  ...
  - [环境变量](#环境变量)
  - [构建包的依赖项](#构建包的依赖项)
  - [下载gluon软件包](#下载gluon软件包)
    - [下载机械臂ROS软件](#下载机械臂ros软件)
    - [安装依赖包并编译](#安装依赖包并编译)
    - [配置运行环境](#配置运行环境)
  - [仿真与控制](#仿真与控制)
  - [Rviz 控制模式](#rviz-控制模式)
  - [Moveit + Rviz控制模式](#moveit--rviz控制模式)
  - [Moveit教程实例](#moveit教程实例)
  - [常见问题](#常见问题)
    - [curl not found](#curl-not-found)
    - [catkin\_make not found](#catkin_make-not-found)
  - [编译时常见错误](#编译时常见错误)
    - [Could NOT find ros-control-boilerplate](#could-not-find-ros-control-boilerplate)
    - [Could NOT find moveit\_core](#could-not-find-moveit_core)
    - [Could NOT find moveit\_visual\_tools](#could-not-find-moveit_visual_tools)
    - [Could NOT find moveit\_ros\_planning\_interface](#could-not-find-moveit_ros_planning_interface)
    - [Could NOT find moveit\_ros\_perception](#could-not-find-moveit_ros_perception)
    - [fatal error: actuatorcontroller.h](#fatal-error-actuatorcontrollerh)
  - [运行时常见错误](#运行时常见错误)
    - [Could not find the GUI, install the 'joint\_state\_publisher\_gui' package](#could-not-find-the-gui-install-the-joint_state_publisher_gui-package)
    - [Exception while loading controller manager 'moveit\_simple\_controller/MoveItSimpleControllerManager'](#exception-while-loading-controller-manager-moveit_simple_controllermoveitsimplecontrollermanager)
    - [Exception while loading planner 'ompl\_interface/OMPLPlanner'](#exception-while-loading-planner-ompl_interfaceomplplanner)
    - [PluginlibFactory: The plugin for class 'moveit\_rviz\_plugin/MotionPlanning’ failed to load'](#pluginlibfactory-the-plugin-for-class-moveit_rviz_pluginmotionplanning-failed-to-load)
    - [Connected error code: 803](#connected-error-code-803)
